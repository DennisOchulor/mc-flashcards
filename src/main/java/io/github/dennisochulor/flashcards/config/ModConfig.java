...
public record ModConfig(int interval, boolean intervalToggle, HashMap<String,Boolean> categoryToggle, List<String> correctAnswerCommands, List<String> wrongAnswerCommands) {
    public ModConfig {
